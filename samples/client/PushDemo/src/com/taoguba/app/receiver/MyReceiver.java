package com.taoguba.app.receiver;
...
import com.taoguba.app.MyApplication;
import com.taoguba.app.PustDemoActivity;
...
public class MyReceiver extends PushEventReceiver {
    ...
    public void onToken(Context context, String token, Bundle extras){
        ...
        Log.i(PustDemoActivity.TAG, content);
        String imei =((TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId();
        Log.i(PustDemoActivity.TAG, "imei==="+imei);
